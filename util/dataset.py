...
class SemData(Dataset):
    def __init__(self, split=0, shot=1, data_root=None, data_list=None, data_set=None, use_split_coco=False, \
        ...
        # ./lists/pascal/fss_list/train/data_list_0.txt
    ...
    def __getitem__(self, index):
        ...
        if self.transform is not None:
            ...
            for k in range(self.shot):
                support_image_list[k], support_label_list[k], support_padding_list[k] = self.transform(support_image_list_ori[k], support_label_list_ori[k], support_padding_list[k])
